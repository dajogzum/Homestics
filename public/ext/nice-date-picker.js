...
(function (global, factory) {
    ...
    niceDatePicker.prototype.buildUi = function (year, month) {
        ...
        this.dayWords = [['一', '二', '三', '四', '五', '六', '日'], ['Pon', 'Wt', 'Śr', 'Cz', 'Pt', 'Sob', 'Nie']];
        this.enMonthsWords = ['Styczeń', 'Luty', 'Marzec', 'Kwiecień', 'Maj', 'Czerwiec', 'Lipiec', 'Sierpień', 'Wrzesień', 'Październik', 'Listopad', 'Grudzień'];
